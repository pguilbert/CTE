        ...
        <div class="content">
            <div class="">
                ...
                <div class="" id="administration" style="">
                    ...
                    <button type="button" class="btn btn-link">Liste des élèves</button>
                    <button type="button" class="btn btn-link">Liste des syllabus</button>
                    <button type="button" class="btn btn-link">Importation</button>
                </div>
                    ...
                    <div class="tabbable">
                        <ul class="nav nav-tabs">
                            ...
                            <li><a href="#I4i" data-toggle="tab">I4 initiaux</a></li>
                            <li><a href="#I4a" data-toggle="tab">I4 alternant</a></li>
                            <li><a href="#I5i" data-toggle="tab">I5 initiaux</a></li>
                            <li><a href="#I5a" data-toggle="tab">I5 alternant</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="columnLeft">
                        <div class="tabbable tabs-left">
                            <ul class="nav nav-tabs">
                                <li><a href="#Francais" data-toggle="tab">Francais</a></li>
